...
Show measurement times in circadian units
```{r}
24*mt
```

Specify signal parameters and compare exact vs Monte Carlo power estimate
```{r}
...
Assume study wants to use equispaced and detect signals of amplitude > 1 with at least 80% power
```{r}
thresh      = .8
N           = 4
freq        = 1
