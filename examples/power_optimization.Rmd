...
Interpretation: The returned binary vector `bvec` indicates selected grid locations. Converting to `meas_times` yields the actual schedule for downstream power evaluation or simulation.
...
## Practical guidance
- Choose `Nfine` to match your feasible resolution (e.g., 30 min ⇒ `Nfine=48`). Larger `Nfine` grows the search space.
