...
#'
#' @description
#' Returns the smallest eigenvalue of the power matrix B^{-1} = (H (X^TX)^{-1}
#' H^T)^{-1}. This eigenvalue is equal to worst-case value of the noncentrality
#' parameter across all signals with amplitude A=1 and noise strength sigma=1.
#'
...
#'
#' @note To calculate worst eigenvalue across multiple frequencies and
#' acrophases, use the wrapper function [evalMinEigMultiFreq()]
