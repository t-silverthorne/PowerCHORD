...
#' @param cleanTempDir boolean variable, if true the file located at \code{db_fname} generated by the C script
#' will be deleted at the end of the function call.
